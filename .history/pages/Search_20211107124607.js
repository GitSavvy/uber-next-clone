...
const SavedPlaces= tw.div`flex bg-white mt-2.5 items-center h-10`
const StarIcon= tw.img`bg-gray-400 rounded-full h-10 w-10 p-2 mr-2 ml-2 `
const ConfirmLocation= tw.div`bg-black text-white h-10 flex items-center px-20`
