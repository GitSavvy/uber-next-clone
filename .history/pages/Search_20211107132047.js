...
const BackButton= tw.img`h-10 cursor-pointer px-1`
...
const ConfirmLocation= tw.div`bg-black text-white h-10    mt-6  mr-6 ml-6 flex flex-col items-center justify-center rounded-full cursor-pointer `
